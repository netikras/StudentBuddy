...
@RestApiTemplate(baseUrlPrefix = API_URL, baseUrl = "/location", cruds = {
        @GenerateCrud(dtoType = BuildingDto.class, url = "/building"),
        @GenerateCrud(dtoType = BuildingSectionDto.class, url = "/building/section"),
        @GenerateCrud(dtoType = AddressDto.class, url = "/address")
})
