...
public enum HttpStatus {
    ...
    /** This code was defined in 1998 as one of the traditional IETF April Fools' jokes, in RFC 2324, Hyper Text Coffee Pot Control Protocol, and is not expected to be implemented by actual HTTP servers. However, known implementations do exist. An Nginx HTTP server uses this code to simulate goto-like behaviour in its configurator. */
    @Deprecated
    IM_A_TEAPOT(
            418,
            "I'm A Teapot",
    ...
    /** The 506 status code indicates that the server has an internal configurator error: the chosen variant resource is configured to engage in transparent content negotiation itself, and is therefore not a proper end point in the negotiation process. */
    ...
    private static final Map<Integer, HttpStatus> codesMap;
    static {
        codesMap = new HashMap<>();

        codesMap.put(100, CONTINUE);
        codesMap.put(101, SWITCHING_PROTOCOLS);
        codesMap.put(102, PROCESSING);
        codesMap.put(200, OK);
        codesMap.put(201, CREATED);
        codesMap.put(202, ACCEPTED);
        codesMap.put(203, NON_AUTHORITATIVE_INFORMATION);
        codesMap.put(204, NO_CONTENT);
        codesMap.put(205, RESET_CONTENT);
        codesMap.put(206, PARTIAL_CONTENT);
        codesMap.put(207, MULTI_STATUS);
        codesMap.put(208, ALREADY_REPORTED);
        codesMap.put(226, IM_USED);
        codesMap.put(300, MULTIPLE_CHOICES);
        codesMap.put(301, MOVED_PERMANENTLY);
        codesMap.put(302, MOVED_TEMPORARILY);
        codesMap.put(303, SEE_OTHER);
        codesMap.put(304, NOT_MODIFIED);
        codesMap.put(305, USE_PROXY);
        codesMap.put(306, SUBSEQUENT_REQUESTS_SHOULD_USE_PROXY);
        codesMap.put(307, TEMPORARY_REDIRECT);
        codesMap.put(308, PERMANENT_REDIRECT);
        codesMap.put(400, BAD_REQUEST);
        codesMap.put(401, UNAUTHORIZED);
        codesMap.put(402, PAYMENT_REQUIRED);
        codesMap.put(403, FORBIDDEN);
        codesMap.put(404, NOT_FOUND);
        codesMap.put(405, METHOD_NOT_ALLOWED);
        codesMap.put(406, NOT_ACCEPTABLE);
        codesMap.put(407, PROXY_AUTHENTICATION_REQUIRED);
        codesMap.put(408, REQUEST_TIMEOUT);
        codesMap.put(409, CONFLICT);
        codesMap.put(410, GONE);
        codesMap.put(411, LENGTH_REQUIRED);
        codesMap.put(412, PRECONDITION_FAILED);
        codesMap.put(413, REQUEST_TOO_LONG);
        codesMap.put(414, REQUEST_URI_TOO_LONG);
        codesMap.put(415, UNSUPPORTED_MEDIA_TYPE);
        codesMap.put(416, REQUESTED_RANGE_NOT_SATISFIABLE);
        codesMap.put(417, EXPECTATION_FAILED);
        codesMap.put(418, IM_A_TEAPOT);
        codesMap.put(419, AUTHENTICATION_TIMEOUT);
        codesMap.put(420, METHOD_FAILURE);
        codesMap.put(421, MISDIRECT_REQUEST);
        codesMap.put(422, UNPROCESSABLE_ENTITY);
        codesMap.put(423, LOCKED);
        codesMap.put(424, FAILED_DEPENDENCY);
        codesMap.put(425, UNORDERED_COLLECTION);
        codesMap.put(426, UPGRADE_REQUIRED);
        codesMap.put(427, SOAP_ACTION_REQUIRED);
        codesMap.put(428, PRECONDITION_REQUIRED);
        codesMap.put(429, TOO_MANY_REQUESTS);
        codesMap.put(431, REQUEST_HEADER_FIELDS_TOO_LARGE);
        codesMap.put(444, NO_RESPONSE);
        codesMap.put(449, RETRY_WITH);
        codesMap.put(450, BLOCKED_BY_WINDOWS_PARENTAL_CONTROLS);
        codesMap.put(451, UNAVAILABLE_FOR_LEGAL_REASONS);
        codesMap.put(499, CLIENT_CLOSED_REQUEST);
        codesMap.put(500, INTERNAL_SERVER_ERROR);
        codesMap.put(501, NOT_IMPLEMENTED);
        codesMap.put(502, BAD_GATEWAY);
        codesMap.put(503, SERVICE_UNAVAILABLE);
        codesMap.put(504, GATEWAY_TIMEOUT);
        codesMap.put(505, HTTP_VERSION_NOT_SUPPORTED);
        codesMap.put(506, VARIANT_ALSO_NEGOTIATES);
        codesMap.put(507, INSUFFICIENT_STORAGE);
        codesMap.put(508, LOOP_DETECTED);
        codesMap.put(509, BANDWITCH_LIMIT_EXCEEDED);
        codesMap.put(510, NOT_EXTENDED);
        codesMap.put(511, NETWORK_AUTHENTICATION_REQUIRED);
        codesMap.put(598, NETWORK_READ_TIMEOUT_ERROR);
        codesMap.put(599, NETWORK_CONNECT_TIMEOUT_ERROR);
    ...
    public static HttpStatus resolveStatusCode(int code) {return codesMap.get(code);}
